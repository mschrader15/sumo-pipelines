...
def read_configs(config: ReadConfig, parent_config: DictConfig) -> Generator[DictConfig, None, None]:
    """
...
def generate_random_seed(config: SeedConfig, parent_config: DictConfig) -> Generator[DictConfig, None, None]:
